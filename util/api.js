...
const GetPageList = ({pageSize=30,pageIndex=1,Type,Channel,Area,Plot,Year,orderBy})=>fetchData(URI+`/GetPageList?SearchKey=${SearchKey}&pageSize=${pageSize}&pageIndex=${pageIndex}&Type=${Type}&Channel=${Channel}&Area=${Area}&Plot=${Plot}&Year=${Year}&orderBy=${orderBy}`);
